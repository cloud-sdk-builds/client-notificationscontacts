...
[`@aws-sdk/client-notificationscontacts`](https://www.npmjs.com/package/@aws-sdk/client-notificationscontacts/v/3.982.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-notificationscontacts@3.982.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hFckm6ph55R0zdBKt0WwKHPOqet3KvxIC8bN7P3yAYkMkLnBz+i8D6yMKJ6FMt0j
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-notificationscontacts": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-notificationscontacts@3.982.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-notificationscontacts@3.982.0/index.min.mjs": "sha384-hFckm6ph55R0zdBKt0WwKHPOqet3KvxIC8bN7P3yAYkMkLnBz+i8D6yMKJ6FMt0j"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-notificationscontacts/blob/refs/tags/3.982.0/LICENSE
```
